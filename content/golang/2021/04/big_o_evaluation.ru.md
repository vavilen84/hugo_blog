...
Большое "O" (BigO) - определение сложности алгоритма (зависимость производительности от входных данных). Различают "
...
В результате мы имеем O(N + N + 1).

При вычислении BigO - константы и более быстрые сложности отбрасываются, оставляя наихудший сценарий. Соответственно,
для данного алгоритма сложность будет линейная O(N) (константу и одну N отбраcываем).
