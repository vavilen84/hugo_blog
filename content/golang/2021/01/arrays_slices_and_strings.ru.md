...
Будьте осторожны с копированием слайса  
...
[a]
```
Логично предположить, что в первом случае был скопирован заголовок среза, который содержал ссылку на нижележащий 
массив. А во втором случае были скопированы строки.
