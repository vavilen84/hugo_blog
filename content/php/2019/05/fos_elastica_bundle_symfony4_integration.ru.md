...
бандл: https://github.com/FriendsOfSymfony/FOSElasticaBundle

репозиторий с примером: https://github.com/vavilen84/symfony_4_elastic_search

### 1. Добавляем зависимость в composer.json
``` 
{
    "require": {
...
### 7. App\Service\FOSElasticSearchService.php
```php
<?php
